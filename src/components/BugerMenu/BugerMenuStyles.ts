export const BugerMenuStyles = {
	...
	menu: "fixed top-0 left-0 h-full w-64 bg-background shadow-lg transform transition-transform duration-300 ease-in-out z-50 overflow-y-auto",
	menuOpen: "translate-x-0",
	menuClosed: "-translate-x-full",
	closeButton: "text-primary h-8 w-8",
	navigation: "mt-4",
	navList: "space-y-4 pb-6",
	navItem: "flex items-center px-6 py-2 text-gray-700 hover:text-primary",
	navIcon: "h-8 w-8 mr-4",
	logoutButton:
		"flex items-center px-6 py-2 text-red-custom hover:text-red-600",
