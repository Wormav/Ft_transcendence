	...
	return (
		<Card>
			...
			<div className={YourPictureCardStyle.avatarContainer}>
				<img src={avatarSrc} alt="Profile" className={YourPictureCardStyle.avatar} />
				<button
			...
			>
				<div className={YourPictureCardStyle.container}>
					<div className={YourPictureCardStyle.tabContainer}>
						<div
							className={activeTab === 'upload' ? YourPictureCardStyle.activeTab : YourPictureCardStyle.tab}
							onClick={() => setActiveTab('upload')}
						>
							{t('settings.uploadImage')}
						</div>
						<div
							className={activeTab === 'url' ? YourPictureCardStyle.activeTab : YourPictureCardStyle.tab}
					...
					{activeTab === 'upload' && (
						<>
							...
							>
								{previewImage ? t('settings.chooseAnotherImage') : t('settings.chooseImage')}
							</button>
						</>
					)}
					...
					{error && <p className={YourPictureCardStyle.errorMessage}>{error}</p>}
