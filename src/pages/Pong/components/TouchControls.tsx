		...
		<div className={PongStyle.touchControls}>
			<div className={PongStyle.touchControlLeft}>
				<button
					...
					onTouchStart={() => {
						leftUpPressed.current = true;
					}}
					onTouchEnd={() => {
						leftUpPressed.current = false;
					}}
					onTouchCancel={() => {
						leftUpPressed.current = false;
					}}
				...
				<button
					className={PongStyle.touchButton}
					onTouchStart={() => {
						leftDownPressed.current = true;
					}}
					onTouchEnd={() => {
						leftDownPressed.current = false;
					}}
					onTouchCancel={() => {
						leftDownPressed.current = false;
					}}
			...
			<div className={PongStyle.touchControlRight}>
				<button
					className={PongStyle.touchButton}
					onTouchStart={() => {
						rightUpPressed.current = true;
					}}
					onTouchEnd={() => {
						rightUpPressed.current = false;
					}}
					onTouchCancel={() => {
						rightUpPressed.current = false;
					}}
				...
				<button
					className={PongStyle.touchButton}
					onTouchStart={() => {
						rightDownPressed.current = true;
					}}
					onTouchEnd={() => {
						rightDownPressed.current = false;
					}}
					onTouchCancel={() => {
						rightDownPressed.current = false;
					}}
