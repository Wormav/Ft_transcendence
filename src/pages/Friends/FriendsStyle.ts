const FriendsStyle = {
	...
	tabButton:
		"py-2 sm:py-3 px-3 sm:px-6 font-medium flex-1 text-center text-sm sm:text-base",
	...
	emptyText: "text-base sm:text-lg text-center",
	...
	infoContainer: "ml-4",
	username: "text-base sm:text-lg font-medium text-gray-900",
	statusContainer: "flex items-center text-xs sm:text-sm",
	...
	requestText: "text-xs sm:text-sm text-gray-500",
	buttonContainer:
		"flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0 mt-2 sm:mt-0 w-full sm:w-auto",
	removeButton:
		"px-3 py-1 bg-red-600 text-white rounded-md hover:bg-red-700 cursor-pointer text-xs sm:text-sm w-full sm:w-auto",
	acceptButton:
		"px-3 py-1 bg-primary text-white rounded-md hover:bg-green-700 cursor-pointer text-xs sm:text-sm w-full sm:w-auto",
	declineButton:
		"px-3 py-1 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 cursor-pointer text-xs sm:text-sm w-full sm:w-auto",
