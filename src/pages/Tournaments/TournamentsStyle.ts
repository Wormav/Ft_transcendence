const TournamentsStyle = {
    container: 'w-full max-w-4xl mx-auto p-4 font-default',
    title: 'text-2xl font-bold mb-6 text-center text-primary',
    form: 'space-y-4 mb-8',
    select: 'w-full p-2 bg-gray-200 rounded-md text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary/50',
    playerInput: 'w-full p-2 bg-gray-200 rounded-md text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary/50',
    button: 'w-full bg-primary text-white py-2 px-4 rounded-md hover:bg-primary/80 transition-colors cursor-pointer shadow-md hover:shadow-lg',
    buttonDisabled: 'w-full bg-gray text-white py-2 px-4 rounded-md cursor-not-allowed shadow-md',
    tournament: {
